...
## For this step, I read the feature큦 file and use it to change the
## names of my data set큦 variables, keeping the first two variables
...
## For this step I read the acivity_labels큦 file and use it to
## rename the content of the activity큦 variable according to the data.
...
## For this step I convert the variables큦 names leaving only the 
## alpha numeric characters and converting them to lowercase as the
## tidy data큦 rules say with the gsub function.
